                                               ...
                                               MSG msg, LRESULT *)
{
    ...
    static const auto pGetTouchInputInfo =
        reinterpret_cast<decltype(&::GetTouchInputInfo)>(
            QApiCache::instance().get(QApiCache::SD_User32, "GetTouchInputInfo"_L1));
    static const auto pCloseTouchInputHandle =
        reinterpret_cast<decltype(&::CloseTouchInputHandle)>(
            QApiCache::instance().get(QApiCache::SD_User32, "CloseTouchInputHandle"_L1));
    ...
    pGetTouchInputInfo(reinterpret_cast<HTOUCHINPUT>(msg.lParam),
    ...
    pCloseTouchInputHandle(reinterpret_cast<HTOUCHINPUT>(msg.lParam));
